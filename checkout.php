                ...
                <div class="left-section">
                            ...
                            <div class="button-controls">
                                <div class="qty">
                                    <div class="number">
                                        ...
                                        <span>Quantity: </span>
                                        <input class="input" id="quantity" type="text" value="<?php echo $row8['pro_qty']; ?>" min="1" max="10" readonly />
                    ...
                    ?>
                        <div class="place-order">
                            <div class="btn-outer">
                                <button type="submit" class="checkout-cta" id="checkout">PLACE ORDER</button>
                            </div>
                        </div>
                    <?php
                    } else {
                    ...
                    <div class="pro-details">
                        ...
                        <div class="bill-details right-font">
                            ...
                            <div class="bill flex lines bold-font">
                                ...
                                <input type="hidden" name="total" val="" id="total" class="total">
                            </div>
